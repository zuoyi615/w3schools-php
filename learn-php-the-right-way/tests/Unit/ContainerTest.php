...
class ContainerTest extends TestCase
{
    ...
    public function it_sets_an_entry_manually()
    {
        ...
        $this->assertArrayHasKey(EmailService::class,
            $this->container->entries());
        $this->assertInstanceOf(EmailService::class,
            $this->container->get(EmailService::class));
        $this->assertSame(true,
            $this->container->get(EmailService::class)->send([], 'receipt'));

        $this->assertSame(false, $this->container->has(InvoiceService::class));
        $this->container->set(InvoiceService::class, fn() => true);
        $this->assertArrayHasKey(InvoiceService::class,
            $this->container->entries());
