<?php
    ...
    function errorHandler(int $type, string $message, ?string $file, ?int $line): bool
    {
        echo <<<TEXT
        ...
        return true; // check whether stop executing PHP internal error handler, false->stop, true->not stop
    }
