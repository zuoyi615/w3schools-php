<?php declare(strict_types=1);
  ...
  require_once './2.24-namespace-paddle0.php';
  require_once './2.24-namespace-paddle1.php';
  require_once './2.24-namespace-notification.php';
  require_once './2.24-namespace-stripe0.php';
