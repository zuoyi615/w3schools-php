<?php
  ...
  // $transaction is hold before script ending; besides unset() will delete reference of $transaction and the same as assign to null
  ...
  var_dump($s->scalar);
  echo '<br />';
  $s = (object)null; // empty object: {}
  // var_dump($s->scalar); // Warning, Undefined property
