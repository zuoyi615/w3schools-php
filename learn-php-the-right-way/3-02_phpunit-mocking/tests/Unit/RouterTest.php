<?php
  ...
  namespace PHPUnitMocking\Tests\Unit;

  use PHPUnitMocking\Exceptions\RouteNotFoundException;
  use PHPUnitMocking\Router;
  ...
  class RouterTest extends TestCase {
    ...
    /**
     * @dataProvider \PHPUnitMocking\Tests\DataProviders\RouterDataProvider::routeNotFoundCases()
     * @test
     */
